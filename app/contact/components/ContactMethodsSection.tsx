...
import { Button, Card, CardContent, CardHeader, CardFooter } from '@/src/components';
...
export default function ContactMethodsSection({ className }: ContactMethodsSectionProps) {
      ...
      <div className='max-w-4xl mx-auto space-y-8'>
        ...
        <div className='grid gap-6 md:grid-cols-2'>
          {primaryMethods.map((method) => {
            ...
            return (
              <Card key={method.name} className='border border-border/50 bg-accent space-y-4 hover:shadow-md transition-shadow'>
