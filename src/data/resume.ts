...
const resumeData: ResumeData = {
  ...
  certifications: [
    ...
    },
    {
      ...
      date: 'In Progress',
      lastUpdate: '10/16/2025',
      completionProgress: 52
    },
  ],
  technicalSkills: {
    languages: [
      { name: 'JavaScript', icon: Icons.JavaScript, url: 'https://developer.mozilla.org/en-US/docs/Web/JavaScript' },
      { name: 'TypeScript', icon: Icons.TypeScript, url: 'https://typescriptlang.org' },
      { name: 'Python', icon: Icons.Python, url: 'https://python.org' },
    ],
    frontend: [
      { name: 'HTML', icon: Icons.HTML, url: 'https://developer.mozilla.org/en-US/docs/Web/HTML' },
    ...
    devops: [
      ...
      { name: 'Postman', icon: Icons.Postman, url: 'https://postman.com' },
      { name: 'Sentry', icon: Icons.Sentry, url: 'https://sentry.io' },
    ],
    cloud: [
      { name: 'Azure', icon: Icons.Azure, url: 'https://azure.microsoft.com' },
      { name: 'Cloudflare R2', icon: Icons.Cloudflare, url: 'https://cloudflare.com/products/r2' },
      { name: 'Vercel', icon: Icons.Vercel, url: 'https://vercel.com' },
      { name: 'Heroku', icon: Icons.Heroku, url: 'https://heroku.com' },
      { name: 'Railway', icon: Icons.Railway, url: 'https://railway.app' },
      { name: 'Render', icon: Icons.Render, url: 'https://render.com' }
    ]
  },
  softSkills: [
    {
