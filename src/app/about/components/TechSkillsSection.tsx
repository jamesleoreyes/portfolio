  ...
  return (
    <section className='space-y-6'>
      ...
      <div className='flex flex-col gap-6'>
        <SkillCategory title="Languages" skills={techSkills.languages} />
        <SkillCategory title="Frontend Development" skills={techSkills.frontend} />
        <SkillCategory title="Backend Development" skills={techSkills.backend} />
        <SkillCategory title="Tooling & DevOps" skills={techSkills.devops} />
        <SkillCategory title="Cloud & Infrastructure" skills={techSkills.cloud} />
      </div>
    </section>
  );
}