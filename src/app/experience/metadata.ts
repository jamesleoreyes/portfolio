...
const meta: Meta = {
  title: 'Experience',
  description: 'Explore James Reyes\' professional journey from FedEx delivery driver to Full-Stack Product Engineer. Discover key projects, achievements, and technical evolution across internship, full-time role, and entrepreneurial ventures.'
}
