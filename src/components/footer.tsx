...
import { ThemeToggle, SocialLinks } from '@/src/components';
    ...
    <footer className='border-t border-border/50 bg-background'>
      <div className='mx-auto max-w-screen-xl py-8 border-x border-border/50'>
        <div className='grid grid-cols-1 px-8 gap-8 lg:grid-cols-3'>
          ...
          <div className='flex flex-col justify-center items-center lg:col-span-1 text-center lg:text-left'>
            ...
            <p className='mt-4 text-center text-sm text-muted-foreground max-w-xs mx-auto lg:mx-0'>
              Full-Stack Product Engineer building reliable software that people love to use.
            </p>
          ...
          <div className='lg:col-span-1 text-center'>
            <h2 className='font-semibold text-foreground'>Look Around</h2>
